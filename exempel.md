...
|---|---:|
| Bias | -0.4131 |
| Total (Summa + Bias) | -0.2697 |
| **Output** = sigmoid(-0.2697) | **0.4330** |
...
| Sigmoid derivata | Output × (1 - Output) | 0.2342 |
...
| Target | | 1 |
| Output | | 0.3766 |
| Error | Target - Output | 0.6234 |
| Sigmoid derivata | Output × (1 - Output) | 0.2348 |
| **Delta** | Error × Sigmoid derivata | **0.1464** |
...
|------|--------|------:|
| Output | | 0.4330 |
| Error contribution | Summa från ovan | -0.0331 |
...
| w₁ | -0.4750 | 0.4492 | 0.2 × -0.0021 × 0.4492 = -0.0002 | -0.4752 |
...
| Vikt | Gammal | Input (från Hidden) | Ändring | Ny |
|------|-------:|--------------------:|--------:|---:|
| w₀ | 0.0054 | 0.3713 | 0.2 × 0.1464 × 0.3713 = 0.0109 | 0.0162 |
...
| 2 | 0.4330 | -0.0081 | Hidden |
| 3 | 0.3743 | -0.0877 | Output (y₀) |
| 4 | 0.3766 | 0.1464 | Output (y₁) |
